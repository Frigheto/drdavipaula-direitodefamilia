        ...
        <div className="mb-16 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Button
              ...
              onClick={() => {
                (window as any).gtag?.('event', 'conversion', { 'send_to': 'AW-18087908707/rrMlCOad9qgcEOOq_rBD' });
                window.open('https://wa.me/558791098958?text=Olá! Gostaria de marcar uma consulta.', '_blank');
              }}
            >
            ...
            <Button
              ...
              onClick={() => {
                (window as any).gtag?.('event', 'conversion', { 'send_to': 'AW-18087908707/rrMlCOad9qgcEOOq_rBD' });
                window.open('https://wa.me/558791098958?text=Olá! Gostaria de tirar uma dúvida.', '_blank');
              }}
            >
              Enviar Mensagem
            </Button>
