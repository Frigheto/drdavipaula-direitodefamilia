    ...
    <section id="inicio" className="relative pt-32 pb-32 overflow-hidden min-h-[600px]">
      ...
      <div className="container max-w-4xl mx-auto px-4 text-center relative z-10">
        ...
        <p className="text-muted-foreground text-lg max-w-2xl mx-auto mb-10">
          Atendimento humanizado e personalizado em todas as questões que envolvem família e afeto. Trabalho com Divórcio, Pensão, Guarda, Curatela e Inventário.
        </p>
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
          <Button
            ...
            onClick={() => { (window as any).gtag?.('event', 'conversion', {'send_to': 'AW-18087908707/rrMlCOad9qgcEOOq_rBD'}); window.open('https://wa.me/5587991098958?text=Olá! Gostaria de analisar meu caso.', '_blank'); }}
          >
