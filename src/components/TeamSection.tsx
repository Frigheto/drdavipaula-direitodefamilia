      ...
      <div className="max-w-6xl mx-auto relative z-10">
        ...
        <div className="text-center">
          <Button
            ...
            onClick={() => { (window as any).gtag?.('event', 'conversion', {'send_to': 'AW-18087908707/rrMlCOad9qgcEOOq_rBD'}); window.open('https://wa.me/5587991098958?text=Olá! Gostaria de agendar uma consulta.', '_blank'); }}
          >
            Agendar Consulta
          </Button>
        </div>
